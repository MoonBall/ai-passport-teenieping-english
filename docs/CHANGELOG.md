...
- Add a separate Teenieping spoken-English project with 17 distinct characters in the original character order, four Create image frames per scene, and unchanged bilingual narration controls. Preserve the independent Grigio project.

## Unreleased

- Added Grigio spoken English cards: 17 classroom phrases, UP/DOWN navigation, short-press English playback, long-press complete bilingual lessons, and four-frame Grigio storyboards generated with ChatGPT Create image.
