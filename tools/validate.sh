...
run_static_checks() {
    ...
    python3 tools/check_spoken_assets.py --require-storyboards
    ...
    "${CC:-cc}" -std=c11 -Wall -Wextra -Werror -Imain tests/test_spoken_core.c main/spoken_core.c -o "${test_dir}/test_spoken_core"
    "${test_dir}/test_spoken_core"
...
run_firmware_checks() (
    ...
    python3 tools/check_spoken_assets.py --require-storyboards --firmware "${validation_build_dir}/FoloToy-AI-Passport-full.bin"
    mkdir -p "${repo_root}/build"
    install -m 0644 \
        "${validation_build_dir}/FoloToy-AI-Passport-full.bin" \
        "${repo_root}/build/FoloToy-AI-Passport-full.bin"
    install -m 0644 "${validation_build_dir}/FoloToy-AI-Passport.elf" "${repo_root}/build/FoloToy-AI-Passport.elf"
